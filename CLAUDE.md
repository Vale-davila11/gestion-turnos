...
- MVP completo según el alcance del prompt original. Pendiente (opcional, fuera del alcance original): tomar las capturas de pantalla reales y revisar las vulnerabilidades NU1903 (Microsoft.OpenApi, SQLitePCLRaw) cuando haya versiones más nuevas.
